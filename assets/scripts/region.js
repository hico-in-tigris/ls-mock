...
function renderRegion(container) {
    ...
    container.innerHTML = `
        <div class="animate-fade-in">
            <!-- Header -->
            <div class="mb-8">
                <h1 class="text-3xl font-bold tracking-tight">地域設定・情報管理</h1>
            ...
            <div class="card mb-6">
                <div class="card-header">
                    <h2 class="text-xl font-semibold">基本地域設定</h2>
                    <p class="text-sm text-muted-foreground">活動拠点となる地域の基本情報を設定</p>
                </div>
                <div class="card-content">
                    <div class="grid gap-6 md:grid-cols-2">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">都道府県</label>
                            <select id="region-prefecture" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500" onchange="updateRegionMunicipalities()">
                                <option value="">選択してください</option>
                                <option value="北海道" ${userRegion.prefecture === '北海道' ? 'selected' : ''}>北海道</option>
                                <option value="青森県" ${userRegion.prefecture === '青森県' ? 'selected' : ''}>青森県</option>
                                <option value="岩手県" ${userRegion.prefecture === '岩手県' ? 'selected' : ''}>岩手県</option>
                                <!-- More prefectures would be added in real implementation -->
                            </select>
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">市町村</label>
                            <select id="region-municipality" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                <option value="">都道府県を選択してください</option>
                                ${userRegion.prefecture === '北海道' ? `
                                    <option value="喜茂別町" ${userRegion.municipality === '喜茂別町' ? 'selected' : ''}>喜茂別町</option>
                                    <option value="真狩村" ${userRegion.municipality === '真狩村' ? 'selected' : ''}>真狩村</option>
                                    <option value="留寿都村" ${userRegion.municipality === '留寿都村' ? 'selected' : ''}>留寿都村</option>
                                    <option value="ニセコ町" ${userRegion.municipality === 'ニセコ町' ? 'selected' : ''}>ニセコ町</option>
                                ` : ''}
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 flex space-x-4">
                        ...
                        <button onclick="loadRegionDataAndRefreshIssues()" 
            ...
            <div class="grid gap-6 md:grid-cols-2 mb-6">
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-xl font-semibold">地域プロフィール</h2>
                        <p class="text-sm text-muted-foreground">地域の基本データと特徴</p>
                    </div>
                    <div class="card-content" id="region-profile-content">
                        ${renderRegionProfile(userRegion)}
                    </div>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <h2 class="text-xl font-semibold">主要指標</h2>
                        <p class="text-sm text-muted-foreground">地域の重要な統計データ</p>
                    </div>
                    <div class="card-content" id="region-metrics-content">
                        ${renderRegionMetrics(userRegion)}
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-6">
                <div class="card-header">
                    <h2 class="text-xl font-semibold">地域特性・資源</h2>
                    <p class="text-sm text-muted-foreground">地域の強みと活用可能な資源</p>
                </div>
                <div class="card-content">
                    <div class="grid gap-6 md:grid-cols-3">
                        ...
                        <div>
                            ...
                            <button onclick="addIndustry()" class="mt-2 text-sm text-blue-600 hover:text-blue-700">+ 産業を追加</button>
                        </div>
                        ...
                        <div>
                            ...
                            <button onclick="addTourismSpot()" class="mt-2 text-sm text-blue-600 hover:text-blue-700">+ 資源を追加</button>
                        </div>
                        ...
                        <div>
                            ...
                            <button onclick="addInfrastructure()" class="mt-2 text-sm text-blue-600 hover:text-blue-700">+ 施設を追加</button>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card mb-6">
                <div class="card-header">
                    <div class="flex justify-between items-start">
                        <div>
                            <h2 class="text-xl font-semibold">地域課題管理</h2>
                            <p class="text-sm text-muted-foreground">地域の課題を整理・分析し、解決策を検討</p>
                        </div>
