        ...
        <div class="animate-fade-in">
            <div class="flex justify-between items-center mb-8">
                ...
                <div class="flex gap-2">
                    <button class="design-btn inline-flex items-center justify-center rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2" data-mode="ideation">
